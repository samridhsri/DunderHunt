...
import { Check, BookmarkX, ArrowRight, Building2, MapPin, Sparkles, UserCheck, ExternalLink } from "lucide-react";
            ...
            <div className="mt-1 flex items-center gap-2">
              ...
              {jobLink && (
                <a
                  ...
                  className="inline-flex items-center justify-center p-1 rounded-lg text-cyan-400 hover:text-cyan-300 hover:bg-cyan-950/60 transition-colors"
        ...
        <div className="flex items-center gap-2">
          {jobLink && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1 rounded-xl bg-cyan-950/40 border border-cyan-500/30 px-3 py-2 text-xs font-semibold text-cyan-400 hover:bg-cyan-900/60 hover:text-cyan-300 transition-all shadow-sm"
            >
